...
- No production prompt content was changed for WP-012 - the live smoke test (see below) produced an informative `NOT_FOUND` verdict rather than exposing a prompt-contract defect.
